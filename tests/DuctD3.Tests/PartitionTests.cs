// Tests for partition layout (icicle/sunburst)
...
public class PartitionTests
{
    ...
    public void Partition_ChildrenAtNextDepth()
    {
        ...
        // Children Y0 should equal root Y1
    ...
    public void Partition_Descendants()
    {
        ...
        Assert.Equal(5, node.Descendants().Count()); // root + a + b + b1 + b2
    }
}
