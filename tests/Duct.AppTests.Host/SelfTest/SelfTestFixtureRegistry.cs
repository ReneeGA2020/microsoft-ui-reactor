...
internal static class SelfTestFixtureRegistry
{
    ...
    [
        ...
        // Hosting coverage — DuctHostControl, DuctHost paths, DuctPageHelper
    ...
    public static SelfTestFixtureBase? Create(string name, Harness harness) => name switch
    {
        ...
        // Hosting coverage
        "Hosting_HostControlMountComponent" => new HostingCoverageFixtures.DuctHostControlMountComponent(harness),
        "Hosting_HostControlMountFunc" => new HostingCoverageFixtures.DuctHostControlMountFunc(harness),
        "Hosting_HostControlFactory" => new HostingCoverageFixtures.DuctHostControlFactory(harness),
        "Hosting_HostControlRenderCallback" => new HostingCoverageFixtures.DuctHostControlRenderCallback(harness),
        "Hosting_HostRenderStats" => new HostingCoverageFixtures.DuctHostRenderStats(harness),
        "Hosting_HostDispose" => new HostingCoverageFixtures.DuctHostDispose(harness),
        "Hosting_PageHelperExercise" => new HostingCoverageFixtures.DuctPageHelperExercise(harness),
