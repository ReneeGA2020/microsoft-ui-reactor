            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    ...
                    NavigationView(
                        ...
                        content: phase == 0 ? Text("NV_Page1") : Text("NV_Page2")
                    )
                );
            });
        ...
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    ...
                    SplitView(
                        pane: Text("ExPane"),
                        content: Text(phase == 0 ? "ExContent1" : "ExContent2")
                    ),
                    NavigationView(
            ...
            try
            {
                host.Mount(ctx =>
                {
                    ...
                    return VStack(
                        ...
                        phase == 0
                            ? Text("BM_Before").FontSize(12)
                            : Text("BM_After").FontSize(24).Bold()
                    );
                });
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    ...
                    Expander(
                        ...
                        phase == 0 ? Text("ExpContent1") : VStack(Text("ExpContent2a"), Text("ExpContent2b")),
                        isExpanded: true,
                        onExpandedChanged: _ => { })
                );
            });
