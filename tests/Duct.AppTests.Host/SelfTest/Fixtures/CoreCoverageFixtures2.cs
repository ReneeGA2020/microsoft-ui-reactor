...
/// <summary>
/// Wave 2 core coverage fixtures targeting remaining Duct\Core gaps:
    ...
    internal class UseEffectCleanup(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    Text($"Effect:{effectCount} Cleanup:{cleanupCount}"),
    ...
    internal class UseObservableTreeHook(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return Text($"Tree:{observed.Child.Name}");
            });
        ...
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    ...
                    Text($"Commands:{cut.Label},{copy.Label},{paste.Label},{undo.Label},{redo.Label}"),
                    Text($"More:{del.Label},{selectAll.Label},{open.Label},{close.Label},{share.Label}"),
                    Text($"Media:{pause.Label},{stop.Label},{fwd.Label},{bwd.Label}")
                );
            });
...
#pragma warning restore CS0067
        ...
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    ...
                    Text($"CanExec:{ductCmd.CanExecute}")
                );
            });
    ...
    private class TypedPropsComponent : Duct.Core.Component<CounterProps>
    {
        public override Element Render()
        {
            return Text($"Typed:{Props.Label}={Props.Count}");
        }
    }
    ...
    internal class ComponentTypedProps(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    UI.Component<TypedPropsComponent, CounterProps>(new CounterProps(count, "items")),
    ...
    internal class ContextScopeExercise(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            var ThemeContext = new DuctContext<string>("default-theme");
    ...
    internal class UseCommandAsyncExercise(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                var cmd = ctx.UseCommand(new DuctCommand
                {
                    Label = "Async",
                    ExecuteAsync = async () =>
                    {
                ...
                return VStack(
                    ...
                    Text($"Executing:{cmd.IsExecuting}")
                );
            });
    ...
    internal class UseCommandTypedAsyncExercise(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                var cmd = ctx.UseCommand(new DuctCommand<string>
                {
                    Label = "TypedAsync",
                ...
                return VStack(
                    ...
                    Text($"TypedExec:{cmd.IsExecuting}")
                );
            });
    ...
    private class AlwaysUpdateComponent : Duct.Core.Component
    {
        ...
        public override Element Render()
        {
            ...
            return Text($"AlwaysUpdate:{RenderCount}");
        }
    }
    ...
    internal class ProplessComponentShouldUpdate(Harness h) : SelfTestFixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                return VStack(
                    UI.Component<AlwaysUpdateComponent>(),
