...
internal static class ObservableFixtures
{
    ...
    internal class UseObservableRerenderComponent : Component
    {
        ...
        public override Element Render()
        {
            ...
            return VStack(
                Text($"Name: {_person.Name}").AutomationId("NameDisplay"),
                Text($"Age: {_person.Age}").AutomationId("AgeDisplay"),
    ...
    internal class UseObservableExternalComponent : Component
    {
        ...
        public override Element Render()
        {
            UseObservable(_person);
            return VStack(
                Text($"Name: {_person.Name}").AutomationId("ExtNameDisplay"),
    ...
    internal class UseObservablePropertyComponent : Component
    {
        ...
        public override Element Render()
        {
            ...
            return VStack(
                Text($"Name: {name}").AutomationId("PropNameDisplay"),
    ...
    internal class UseCollectionComponent : Component
    {
        ...
        public override Element Render()
        {
            ...
            return VStack(
                Text($"Count: {list.Count}").AutomationId("CollectionCount"),
                VStack(list.Select((item, idx) =>
                    Text(item).AutomationId($"CollItem{idx}")
                ).ToArray()),
    ...
    internal class UseObservableSourceSwapComponent : Component
    {
        ...
        public override Element Render()
        {
            ...
            return VStack(
                Text($"Name: {current.Name}").AutomationId("SwapNameDisplay"),
