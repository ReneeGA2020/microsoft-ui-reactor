...
public class DeclarativeModifierTests
{
    ...
    {
        var weight = new Windows.UI.Text.FontWeight(700);
    ...
    public void FontSize_On_TextElement_Uses_General_Modifier()
    {
        ...
        var el = (Element)Text("Hi").FontSize(20);
    ...
    public void OnSizeChanged_Stores_Handler_In_Modifiers()
    {
        ...
        var el = Border(Text("x")).OnSizeChanged(handler);
        Assert.NotNull(el.Modifiers);
    ...
    public void OnPointerPressed_Stores_Handler()
    {
        ...
        var el = Border(Text("x")).OnPointerPressed(handler);
    ...
    {
        Action<object, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs> handler = (s, e) => { };
        var el = Border(Text("x")).OnPointerMoved(handler);
    ...
    {
        Action<object, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs> handler = (s, e) => { };
        var el = Border(Text("x")).OnPointerReleased(handler);
    ...
    public void OnKeyDown_Stores_Handler()
    {
        ...
        var el = Border(Text("x")).OnKeyDown(handler);
    ...
    {
        var items = new[] { Text("A"), Text("B"), Text("C") };
    ...
    {
        var grid = UniformGrid(Orientation.Horizontal, Text("A"), Text("B"), Text("C"));
    ...
    {
        var grid = UniformGrid(Orientation.Vertical, Text("A"), Text("B"));
    ...
    {
        var grid = UniformGrid(Orientation.Horizontal, Text("A"), null, Text("B"));
