                ...
                host.Mount(ctx =>
                {
                    return VirtualListDsl.VirtualList(
                        ...
                        renderItem: index =>
                        {
                            ...
                            cells[0] = Factories.Text($"{index}").Padding(8, 4).VAlign(VerticalAlignment.Center).Grid(row: 0, column: 0);
                            cells[1] = Factories.Text($"Emp-{index:D6}").Padding(8, 4).VAlign(VerticalAlignment.Center).Grid(row: 0, column: 1);
                            cells[2] = Factories.Text($"Dept-{index % 12}").Padding(8, 4).VAlign(VerticalAlignment.Center).Grid(row: 0, column: 2);
                            cells[3] = Factories.Text($"Title-{index % 50}").Padding(8, 4).VAlign(VerticalAlignment.Center).Grid(row: 0, column: 3);
