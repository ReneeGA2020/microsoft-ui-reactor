#!/bin/bash
# StressPerf Benchmark Suite — includes DuctCpp variant
# Runs all variants at 10%, 50%, 100% update rates, 7s each.
...
echo "=== StressPerf Benchmark Suite (with DuctCpp) ==="
...
for pct in 10 50 100; do
    ...
    run_app "$DUCTCPP_EXE" "WinUI.DuctCpp" "$pct"
