...
DuctApp.Run<StockGridApp>("StressPerf.DuctGrid", fullScreen: true);

// ---------------------------------------------------------------------------

class StockGridApp : Component
{
    private const string AppName = "StressPerf.DuctGrid";
        ...
        return VStack(
            ...
            DataGridDsl.DataGrid(
                ...
                cellTemplate: ctx =>
                {
                    ...
                    return Text(StockDataSource.FormatCell(in item))
                        .FontSize(8)
