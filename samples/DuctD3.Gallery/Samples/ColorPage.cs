// Color page — Showcases WinUI 3 theme resource brushes via Duct's Theme API.
...
public class ColorPageSample : GallerySample
{
    ...
    public override string Description =>
        "WinUI 3 theme resource brushes you can reference in Duct. " +
    ...
    public override string SourceCode => """
        ...
        Text("Custom").Foreground(Theme.Ref("SystemFillColorSuccessBrush"))
        """;

    public override Element Render()
    {
        return VStack(16,
            Text("The brushes below are part of WinUI 3. Reference them in Duct via the Theme API:")
                .Foreground(Theme.SecondaryText),

            HStack(8,
                Text("Text(\"Hello\").Foreground(").Foreground(Theme.SecondaryText),
                Text("Theme.PrimaryText").Foreground(Theme.AccentText).SemiBold(),
                Text(")").Foreground(Theme.SecondaryText)
            ),
    ...
    private static Element BrushSwatch(BrushInfo info)
    {
        ...
        return HStack(8,
            ...
            VStack(0,
                (Text(info.DuctToken) with { FontSize = 12 })
                    .SemiBold()
                    .Foreground(Theme.PrimaryText),
                (Text(info.ResourceKey) with { FontSize = 11 })
    ...
    private record BrushInfo(string DuctToken, string ResourceKey);
