        ...
        return D3Canvas(canvasW, canvasH,
            [// Column headers
             ...
             .. ys.Ticks(6).SelectMany(t => new Element[]
             {
                 ...
                 D3Text(xLeft - 28, ys.Map(t) - 7, Fmt(t), 9, Gray(140)),
                 D3Text(xRight + 8, ys.Map(t) - 7, Fmt(t), 9, Gray(140)),
             }),
             ...
             .. items.SelectMany(item =>
             {
                 ...
                 return new Element[]
                 {
                     ...
                     D3Text(4, y1 - 7, $"{item.Label} ({item.Before:F0})", 10, brush),
                     D3Text(xRight + 30, y2 - 7, $"{item.Label} ({item.After:F0})", 10, brush),
                 };
             }),
