...
class DataSystemDemo : Duct.Core.Component
{
...
class PropertyGridFullEditorDemo : Duct.Core.Component
{
    public override Element Render()
    {
        var registry = UseMemo(() =>
        {
            ...
            reg.Register<RgbColor>(new TypeMetadata
            {
                ...
                {
                    var c = (RgbColor)val;
                    return Text(c.ToString()).SemiBold();
                },
                FullEditor = (val, onChange) =>
                {
                    var c = (RgbColor)val;
                    return FlexColumn(
                        Text("RGB Color Editor").SemiBold(),
                        FlexRow(
                            Text("R:").Width(20),
        ...
        return FlexColumn(
            ...
            Border(
                VStack(4,
                    Text("Live values:").SemiBold(),
                    Text($"Name={spriteRef.Current.Name}, Health={spriteRef.Current.Health}, " +
...
class VirtualListFixedDemo : Duct.Core.Component
{
    public override Element Render()
    {
...
class VirtualListVariableDemo : Duct.Core.Component
{
    public override Element Render()
    {
...
class DataSourceDemo : Duct.Core.Component
{
    public override Element Render()
    {
        var source = UseMemo(() =>
                ...
                : page is not null
                    ? FlexColumn(
                        ...
                        FlexRow(
                            ...
                            Text("Name").Width(180).SemiBold(),
                            Text("Department").Width(120).SemiBold(),
                            Text("Age").Width(50).SemiBold(),
                            Text("Salary").Width(100).SemiBold()
                        ) with { ColumnGap = 8 },
...
class FormFieldDemo : Duct.Core.Component
{
    public override Element Render()
    {
        ...
        return FlexColumn(
            ...
            Border(
                VStack(4,
                    ...
                    Text($"Name=\"{name}\", Age={age}, Department=\"{dept}\"")
                )
