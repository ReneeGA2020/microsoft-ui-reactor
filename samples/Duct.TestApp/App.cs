...
class PropertyGridDemo : Component
{
    ...
    class SpriteSettings : System.ComponentModel.INotifyPropertyChanged
    {
    ...
    class MaterialSettings : System.ComponentModel.INotifyPropertyChanged
    {
    ...
    public override Element Render()
    {
        ...
        return VStack(16,
            ...
            Border(
                VStack(4,
                    Text("Live values (updated via INPC / OnRootChanged):").SemiBold(),
                    selectedItem switch
                    {
                        "Sprite" => Text($"Name={spriteRef.Current.Name}, Visible={spriteRef.Current.Visible}, " +
                                         $"X={spriteRef.Current.X:F1}, Y={spriteRef.Current.Y:F1}, " +
                                         $"Rotation={spriteRef.Current.Rotation:F1}, " +
                                         $"Bounds={spriteRef.Current.Bounds}"),
                        "Material" => Text($"Material={materialRef.Current.MaterialName}, " +
