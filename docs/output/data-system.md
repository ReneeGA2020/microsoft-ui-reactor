...
Duct's data system provides a virtualized `DataGrid<T>` backed by a
...
Import both DSLs: `using static Duct.DataGrid.DataGridDsl;` and
...
- **[WinForms Interop](winforms-interop.md)** — next topic: host Duct components inside WinForms apps
