...
/// <summary>
/// Provides the DuctContext definition for propagating ValidationContext through the tree.
/// </summary>
public static class ValidationContexts
{
    /// <summary>
    /// The DuctContext definition used to propagate ValidationContext through the tree.
    /// Default value is null (no validation context provided by any ancestor).
    /// </summary>
    public static readonly DuctContext<ValidationContext?> Current = new(null, "ValidationContext");
}
