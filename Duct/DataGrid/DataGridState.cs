...
public class DataGridState<T>
{
    ...
    private static List<T> ApplyClientSort(List<T> items, List<SortDescriptor> sorts)
    {
        ...
        {
            var prop = typeof(T).GetProperty(sort.Field, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
    ...
    private static List<T> ApplyClientFilters(List<T> items, List<FilterDescriptor> filters)
    {
        ...
        {
            var prop = typeof(T).GetProperty(filter.Field, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
            if (prop is null) continue;
